...
namespace Monitor2.CAN
{
    public static class ControlCAN
    {
        ...
        static ControlCAN()
        {
            ...
            {
                { "10Kbps", new byte[] { 0x9f, 0xff } },
                { "20Kbps", new byte[] { 0x18, 0x1c } },
                { "40Kbps", new byte[] { 0x87, 0xff } },
                { "50Kbps", new byte[] { 0x09, 0x1c } },
                { "80Kbps", new byte[] { 0x83, 0xff } },
                { "100Kbps", new byte[] { 0x04, 0x1c } },
                { "124Kbps", new byte[] { 0x03, 0x1c } },
                { "200Kbps", new byte[] { 0x81, 0xfa } },
                { "250Kbps", new byte[] { 0x01, 0x1c } },
                { "400Kbps", new byte[] { 0x80, 0xfa } },
                { "500Kbps", new byte[] { 0x00, 0x1c } },
                { "666Kbps", new byte[] { 0x80, 0xb6 } },
                { "800Kbps", new byte[] { 0x00, 0x16 } },
                { "1000Kbps", new byte[] { 0x00, 0x14 } },
                { "33.33Kbps", new byte[] { 0x09, 0x6f } },
                { "66.6Kbps", new byte[] { 0x04, 0x6f } },
                { "83.33Kbps", new byte[] { 0x03, 0x6f } }
            };
        }
    }
}
